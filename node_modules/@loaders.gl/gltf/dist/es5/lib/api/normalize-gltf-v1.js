...
var GLTFV1Normalizer = function () {
  ...
  (0, _createClass2.default)(GLTFV1Normalizer, [{
    ...
    function normalize(gltf, options) {
      this.json = gltf.json;
      var json = gltf.json;
    ...
    value:
    function _convertTopLevelObjectToArray(json, mapName) {
    ...
    value:
    function _convertObjectIdsToArrayIndices(json) {
      for (var arrayName in GLTF_ARRAYS) {
    ...
    value:
    function _convertIdsToIndices(json, topLevelArrayName) {
