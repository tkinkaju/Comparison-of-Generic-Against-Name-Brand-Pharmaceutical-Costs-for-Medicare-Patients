...
function W() {
  null === P ? null === O ? (Q = !1, O = P = va()) : (Q = !0, P = O) : null === P.next ? (Q = !1, P = P.next = va()) : (Q = !0, P = P.next);
  return P;
}
...
function ya(a, b, d) {
  ...
  a = a === xa ? "function" === typeof b ? b() : b : void 0 !== d ? d(b) : b;
  P.memoizedState = a;
  a = P.queue = {
    last: null,
    dispatch: null
...
var Ta = function () {
  ...
  a.prototype.renderDOM = function (a, d, c) {
    ...
    c === Ca.html && Da(b);
    Ma.hasOwnProperty(b) || (La.test(b) ? void 0 : r("65", b), Ma[b] = !0);
    var e = a.props;
    if ("input" === b) e = p({
      type: void 0
    }, e, {
    ...
    if (h = e) Fa[b] && (null != h.children || null != h.dangerouslySetInnerHTML ? r("137", b, "") : void 0), null != h.dangerouslySetInnerHTML && (null != h.children ? r("60") : void 0, "object" === _typeof(h.dangerouslySetInnerHTML) && "__html" in h.dangerouslySetInnerHTML ? void 0 : r("61")), null != h.style && "object" !== _typeof(h.style) ? r("62", "") : void 0;
    h = e;
    ...
    for (y in h) {
      if (Pa.call(h, y)) {
        ...
        if (null != l) {
          if ("style" === y) {
            ...
            for (n in l) {
              if (l.hasOwnProperty(n)) {
                ...
                if (null != u) {
                  var w = n;
                  if (Na.hasOwnProperty(w)) w = Na[w];else {
                    var R = w.replace(Ha, "-$1").toLowerCase().replace(Ia, "-ms-");
                    w = Na[w] = R;
                  }
                  k += t + w + ":";
                  t = n;
          ...
          if (m) Qa.hasOwnProperty(y) || (n = y, n = ra(n) && null != l ? n + "=" + ('"' + M(l) + '"') : "");else {
            m = y;
            n = l;
            l = J.hasOwnProperty(m) ? J[m] : null;
            if (u = "style" !== m) u = null !== l ? 0 === l.type : !(2 < m.length) || "o" !== m[0] && "O" !== m[0] || "n" !== m[1] && "N" !== m[1] ? !1 : !0;
            u || ta(m, n, l, !1) ? n = "" : null !== l ? (m = l.attributeName, l = l.type, n = 3 === l || 4 === l && !0 === n ? m + '=""' : m + "=" + ('"' + M(n) + '"')) : n = ra(m) ? m + "=" + ('"' + M(n) + '"') : "";
          }
          n && (B += " " + n);
        }
      }
    ...
    var y = B;
    h = "";
    Ea.hasOwnProperty(b) ? y += "/>" : (y += ">", h = "</" + a.type + ">");
    ...
    null != g ? (e = [], Ka[b] && "\n" === g.charAt(0) && (y += "\n"), y += g) : e = Z(e.children);
    a = a.type;
    c = null == c || "http://www.w3.org/1999/xhtml" === c ? Da(a) : "http://www.w3.org/2000/svg" === c && "foreignObject" === a ? "http://www.w3.org/1999/xhtml" : c;
    this.stack.push({
      domNamespace: c,
      type: b,
      children: e,
...
var Va = function (a) {
  function b(d, c) {
    ...
    f = !f || "object" !== _typeof(f) && "function" !== typeof f ? this : f;
