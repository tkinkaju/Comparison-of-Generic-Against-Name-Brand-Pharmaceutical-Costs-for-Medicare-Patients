...
import { AddDataToMapPayload, ValueOf, Merge, RGBColor, NestedPartial, LayerVisConfig, ColorUI, Feature, InteractionConfig } from '@kepler.gl/types';
 ...
 * @public
 */
export declare function addFilter(dataId: string | null): Merge<AddFilterUpdaterAction, {
 ...
 */
export declare function reorderLayer(order: number[]): Merge<ReorderLayerUpdaterAction, {
 ...
 * @public
 */
export declare function removeLayer(idx: number): Merge<RemoveLayerUpdaterAction, {
 ...
 * @public
 */
export declare function duplicateLayer(idx: number): Merge<DuplicateLayerUpdaterAction, {
 ...
 * @public
 */
export declare function updateVisData(datasets: AddDataToMapPayload['datasets'], options: AddDataToMapPayload['options'], config?: AddDataToMapPayload['config']): Merge<UpdateVisDataUpdaterAction, {
...
export declare type EnlargeFilterUpdaterAction = {
    idx: number;
};
/**
 ...
 * @public
 */
export declare function enlargeFilter(idx: number): Merge<EnlargeFilterUpdaterAction, {
    type: typeof ActionTypes.ENLARGE_FILTER;
}>;
 ...
 * @public
 */
export declare function onLayerHover(info: {
    picked?: boolean;
 ...
 * @public
 */
export declare function onLayerClick(info: {
    picked?: boolean;
} | null): Merge<OnLayerClickUpdaterAction, {
 ...
 * @returns action
 */
export declare function setSelectedFeature(feature: Feature): Merge<SetSelectedFeatureUpdaterAction, {
